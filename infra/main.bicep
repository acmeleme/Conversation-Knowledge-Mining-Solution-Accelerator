...
// TEMPORARILY DISABLED: Deployment scripts require shared key access which is blocked by Azure Policy
// Run these scripts manually after deployment using Container Apps or Azure CLI
/*
...
module webServerFarm 'br/public:avm/res/web/serverfarm:0.5.0' = {
  ...
  params: {
    ...
    // Changed from B3 to P1v2 for better performance with AI workloads (vector search, embeddings, agent processing)
